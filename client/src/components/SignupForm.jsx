...
export default function SignupForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-h-[450px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-gray-800">
      ...
      <button
        type="submit"
        className="w-full bg-linear-to-r from-cyan-500 to-blue-600 text-white font-bold py-3 rounded-lg hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 mt-2 shadow-lg shadow-cyan-500/50 hover:shadow-cyan-500/70 hover:scale-[1.02] active:scale-[0.98]"
      >
        Sign Up
      </button>
    </form>
