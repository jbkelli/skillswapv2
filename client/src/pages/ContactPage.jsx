          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-gray-800 border border-gray-700 text-gray-300 rounded-lg py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-500 transition-colors font-semibold disabled:opacity-50"
            >
          ...
          <div className="mt-8 pt-8 border-t border-gray-800">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              ...
              <a
                ...
                title="WhatsApp: +254 797 237 149"
              >
              ...
              {/* Telegram Icon */}
              <a
                href="https://t.me/254797237149"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition-colors p-2"
                title="Telegram: +254 797 237 149"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Instagram Icon */}
              <a
                href="https://www.instagram.com/marval.tech?igsh=cms0eXl4MDd2MmRl"
                target="_blank"
                rel="noopener noreferrer"
